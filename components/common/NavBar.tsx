...
const NavBar = () => {
  ...
  return (
    <nav className="">
      ...
      {/* Third Section */}
      <section className="w-full border-b border-[#E5E7EB] px-4 py-3 flex flex-col lg:flex-row items-center justify-around">
        ...
        <div className="hidden sm:grid grid-cols-[auto_1fr] items-center gap-x-2">
